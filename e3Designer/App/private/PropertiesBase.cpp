	...
	: e3::Element(pParent)
{
        ...
        mOrientationItem->SetTitle(_s(Orientation));
                UiExpander* pCustomView13 = new UiExpander();
        AddElement(pCustomView13);
        pCustomView13->SetWidth("100%");
                UiExpanderHeaderDefault* pCustomView14 = new UiExpanderHeaderDefault();
        pCustomView13->AddElement(pCustomView14);
        pCustomView14->SetTitle(_s(Background));
                UiExpanderBody* pCustomView15 = new UiExpanderBody();
        pCustomView13->AddElement(pCustomView15);
        pCustomView15->SetWidth("100%");
        pCustomView15->SetAlignItemsHor((e3::EAlignment)1);
        pCustomView15->SetOrientation((e3::EOrientation)1);
        mBgColorItem = new PropItemColor();
        pCustomView15->AddElement(mBgColorItem);
        mBgColorItem->SetTitle(_s(Color));
        mBgImageItem = new PropItemNumber();
        pCustomView15->AddElement(mBgImageItem);
